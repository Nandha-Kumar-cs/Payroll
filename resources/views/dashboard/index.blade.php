<x-layouts.app title="Dashboard">
    <div class="custom_buttons_display">
        <p class="placeholder-copy" style="margin-bottom: 1.25rem;">
            Welcome{{ auth()->user()?->user_name ? ', ' . e(auth()->user()->user_name) : '' }}. Use the sidebar access different sections of the application.
        </p>
        <div class="make_flex">
    ...
    <section class="app-panel">
        ...
        <p class="placeholder-copy">
            ...
            <a href="{{ route('documents.index') }}" class="app-link">Documents</a>
            — Official Documents.
        </p>
    </section>
</x-layouts.app>